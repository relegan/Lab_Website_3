...
app.get('/player_info/post', function(req, res) {
  ...
  var players = 'select name, id from football_players;';
  var info = 'select * from football_players WHERE id = ' + player_id + ';';
  var total_games = 'SELECT COUNT(*) FROM football_games INNER JOIN football_players ON football_players.id=ANY(football_games.players) WHERE id= ' + player_id + ';';
  db.task('get-everything', task => {
      return task.batch([
          task.any(players),
          task.any(info),
